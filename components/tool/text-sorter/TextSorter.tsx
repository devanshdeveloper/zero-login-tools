...
import { sortLines, sortOrderLabels, type SortOrder } from "@/lib/engines/textSorterEngine";
import { Button } from "@/components/ui/button";
import { Textarea } from "@/components/ui/textarea";
import { Check, Copy, Trash2 } from "lucide-react";

const ORDERS: SortOrder[] = ["asc", "desc", "random", "length-asc", "length-desc"];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <h3 className="text-sm font-medium text-muted-foreground">Lines (one per line)</h3>
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <h3 className="text-sm font-medium text-muted-foreground">Sorted</h3>
