...
import { testRegex, validateRegex, type RegexMatch } from "@/registry/engines/regexEngine";
...
export function RegexVisualizer() {
  ...
  const handleCopy = () => {
    ...
    const output = result.matches
      .map((m: any, i: any) => `Match ${i + 1}: "${m.match}" at index ${m.index}`)
      .join("\n");
              ...
              {result.matches.length > 0 && (
                <div className="space-y-2">
                  ...
                  <div className="space-y-2 max-h-[300px] overflow-y-auto">
                    {result.matches.map((match: any, idx: any) => (
                      <div
                        key={idx}
                      ...
                      >
                        ...
                        {match.groups.length > 0 && (
                          <div className="mt-2 space-y-1">
                            ...
                            {match.groups.map((group: any, gIdx: any) => (
                              <div
                                key={gIdx}
